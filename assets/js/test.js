...
function passGen() {
    var charCount = window.prompt("Please choose between 8 and 128 characters for the length of your password.");
    if (charCount === "") {
        window.alert("A blank value is not allowed. Please enter a value between 8 and 128.");
        passGen()
        ...
        passGen()
            ...
            var numbs = window.confirm("Would you like to include numbers in your password?");
            var lC = window.confirm("Would you like to use Lower Case letters in your password?");
            var uC = window.confirm("Would you like to use Upper Case letters in your password?");
            var sC = window.confirm("Would you like to use Special Characters in your password?");
